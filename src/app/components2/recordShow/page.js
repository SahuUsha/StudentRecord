     ...
     <div className="flex flex-wrap w-auto shadow-xl shadow-gray-600 bg-gray-400 rounded-2xl p-12 gap-7 sm:grid-cols-2 justify-center flex   mt-6">
        {
            ...
            :<label className="text-4xl text-white font-bold mb-4 flex justify-center items-center text-center ">No one Students record Found. please add at least One students record</label>
        }
     </div>
     </div>
    </div>
